...
export class ValidationDetailsComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.validationService.validationId$.subscribe(id => {
      this.validationId = id;
      console.log('get validation for ID ' + id + ' and populate data for tables');
