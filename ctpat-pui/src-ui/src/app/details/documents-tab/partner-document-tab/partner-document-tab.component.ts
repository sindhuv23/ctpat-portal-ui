...
export class PartnerDocumentTabComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  doFilter(): void{
    ...
    const filterString = JSON.stringify({documentCat: rawValues.documentCat.trim().toLowerCase(),
  ...
  ngAfterViewInit(): void{
    this.dataDocuments.push({fileName: 'someFile.pdf', type: 'TC Type1', fileSize: '116.35kb', uploadedBy: 'John Doe',
    uploadedDateTime: new Date('06-02-2022 15:33'), documentCat: 'T', version: '1', entryId: 0});
    this.dataDocuments.push({fileName: 'someFile2.doc', type: 'ACCT Type', fileSize: '222.3kb', uploadedBy: 'Sam Partner',
    uploadedDateTime: new Date('05-22-2021 08:21'), documentCat: 'A', version: '3', entryId: 1});
    this.dataDocuments.push({fileName: 'someFile3.jpg', type: 'TC Type2', fileSize: '455.25kb', uploadedBy: 'Someone',
    uploadedDateTime: new Date('01-12-2022 09:21'), documentCat: 'T', version: '1', entryId: 2});
