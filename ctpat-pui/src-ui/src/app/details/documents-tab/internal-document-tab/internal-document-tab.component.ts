...
@Component({
  ...
  templateUrl: './internal-document-tab.component.html',
  styleUrls: ['./internal-document-tab.component.scss']
})
export class InternalDocumentTabComponent implements OnInit, OnDestroy, AfterViewInit {
