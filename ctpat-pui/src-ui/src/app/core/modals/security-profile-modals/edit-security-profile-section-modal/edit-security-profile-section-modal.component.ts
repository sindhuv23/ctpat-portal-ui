...
export class EditSecurityProfileSectionModalComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.questions = [{
      header: 'Audit Program', text: 'Is the supply chain security program designed with, supported by, and implemented by an appropriate written review component?  The purpose of this review component is to document that a system is in place whereby personnel are held accountable for their responsibilities and all security procedures outlined by the security program are being carried out as designed.  This is a requirement.'
    }, {
      header: 'Updating Audit Program', text: 'Is the review plan updated as needed based on pertinent changes in your organization’s operations and level of risk?  This is a requirement.'
    }, {
      header: 'Updates to Management', text: 'The role of a company’s upper management in CTPAT is to provide support and oversight to ensure the creation and maintenance of the company’s Supply Chain Security Program. To this end, do the CTPAT point(s) of contact (POC) provide regular updates regarding the progress or outcomes of any audits, exercises, or validations?'
    }, {
      header: 'Upper Management Resposibility: POC Requirements ', text: 'Are the POCs knowledgeable about CTPAT’s program requirements?  This is a requirement.'
    }, {
      header: 'Statement of Support', text: 'In promoting a culture of security, is commitment to supply chain security and the CTPAT program demonstrated through a statement of support?  Is the statement signed by a senior company official and displayed in appropriate company locations?'
    }];
  }
